...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('movie')" wire:navigate>
                        {{ __('Movies') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <!-- Settings Dropdown -->
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    <div class="ml-1">
                        <button x-on:click="darkMode = !darkMode" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('movie')" wire:navigate>
                    {{ __('Movies') }}
                </x-responsive-nav-link>
        </div>
